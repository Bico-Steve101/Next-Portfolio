					...
					>
						<div className="trm-service-content">
							...
							<div className="trm-mb-15">
								...
								<span className="trm-text-sm">254754426052</span>
							</div>
							<div className="trm-mb-15">
								<span className="trm-label">Personal:</span>{" "}
								<span className="trm-text-sm">254757838398</span>
							</div>
						</div>
					</div>
					{/* contact card end */}
						...
						<div className="trm-service-content">
							...
							<div className="trm-mb-15">
								...
								<span className="trm-text-sm">
									bicosteve101@gmail.com 
								</span>
							</div>
							<div>
								<span className="trm-label">Instagram:</span>{" "}
								<span className="trm-text-sm">@steve_bico1 Steve_</span>
							</div>
						</div>
					</div>
					{/* contact card end */}
